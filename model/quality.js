		...
		cascading: [
			{
				...
				comment: [
					'<li>Sets the minimum Acceptance Criteria for the entire portfolio',
					'<li>Reviews portfolio deliverables'
				]
			}, 
			{
				title: 'Program Product Owner',
				comment: [
					'<li>Sets the minimum Acceptance Criteria for the entire program, which includes the Acceptance Criteria from the portfolio',
					'<li>Reviews program deliverables'
				]
			}, 
			{
				title: 'Product Owner',
				comment: [
					'<li>Sets the minimum Acceptance Criteria for the project, which includes the Acceptance Criteria from the program',
					'<li>Reviews project deliverablese'
				]
			}
		]
	},
...
var txtManagement = {
	...
	planning: {
		...
		integration: [
			'<b>Continuous Integration and Sustainable Pace</b>',
	...
	table: [
         {
             ...
             comments: [
				 ...
				 'Provides framework and guidance for developing Acceptance Criteria',
				 'Defines the range of tools that can be used by the Scrum Team to develop and verify the product'
             ]
         },
		 {
			 owner: 'Portfolio Product Owner',
			 comments: [
				'Sets minimum Acceptance Criteria for the entire portfolio',
				'Reviews portfolio Deliverables'
			 ]
		 },
		 {
			 owner: 'Portfolio Scrum Master',
			 comments: [
				'Ensures that a sustainable pace is maintained in which the focus is on quality of features rather than strictly on velocity'
			 ]
		 },
		 {
			 owner: 'Program Product Owner',
			 comments: [
				'Sets the minimum Acceptance Criteria for the entire program',
				'Reviews program Deliverables'
			 ]
		 },
		 {
		 ...
		 },
		 {
			 owner: 'Stakeholder(s)',
			 comments: [
				'Reviews and accepts the Deliverables and final product'
			 ]
		 },
		 {
			 owner: 'Product Owner',
			 comments: [
				'States the business requirements for the product and defines requirements clearly in the Prioritized Product Backlog',
				'Assesses viability and ensures that Deliverables meet the quality requirements',
				'Sets the minimum Acceptance Criteria for the entire project, including the Acceptance Criteria of the respective program',
				'Facilitates creation of Acceptance Criteria for User Stories',
				'Reviews and validates the Deliverables during Demonstrate and Validate Sprint'
			 ]
		 },
		 {
			 owner: 'Scrum Master',
			 comments: [
				'Facilitates a ‘team first’ mentality when it comes to quality',
				'Eliminates environmental obstructions that may affect the quality of deliverables and processes',
				'Ensures that a sustainable pace is maintained in which the focus is on quality of features rather than strictly on velocity',
		 ...
		 },
		 {
			 owner: 'Scrum Team',
			 comments: [
				'Develops and maintains all Deliverables during Sprints until they are handed over to the end users',
				'Practices and encourages good communication so that the requirements are clarified and fully understood',
				'Shares knowledge to ensure that team members familiarize themselves with the whole feature set and therefore benefit from the experience of others',
				'Makes appropriate changes to Deliverables swiftly'
			 ]
		 }
	]
};
...
exports.txtDefined = txtDefined;
exports.txtAcceptance = txtAcceptance;
