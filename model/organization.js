...
var txtOwner = {
	...
	table: [
        ...
        },
		{
            ...
            comments: [
                 'Creates Release Planning Scheduleacklog',
        ...
        },
		{
            ...
            comments: [
                 'Helps create User Stories Sprint',
		...
		{
            process: '9.5 Create Sprint Backlog Sprint',
            comments: [
		...
		{
            process: '11.2 Demonstrate and Validate Sprints',
            comments: [
...
var txtMaster = {
	...
	table: [
        ...
        },
		{
            process: '8.3 Form Scrum Team',
            comments: [
                 'Facilitates selection of the Scrum TeamFacilitates selection of the Scrum Team',
        ...
        },
		{
            process: '8.5 Create Prioritized Product Backlog',
            comments: [
                 'Helps Product Owner in creation of the Prioritized Product Backlog and in definition of the Done Criteria'
            ]
        },
		{
            process: '8.6 Conduct Release Planning',
        ...
        },
		{
            process: '9.1 Create User Stories',
            comments: [
                 'Assists the Scrum Team in creating User Stories and their Acceptance Criteria'
            ]
        },
		{
            process: '9.2 Approve, Estimate and Commit User Stories',
...
var txtTeam = {
	...
	table: [
		...
		{
            process: '8.5 Prioritized Product Backlog',
            comments: [
        ...
        },
		{
            process: '11.1 Convene Scrum of Scrums',
            comments: [
                 'Provides inputs to Scrum Master for Scrum of Scrums (SoS) Meetings'
            ]
        },
		{
            process: '11.2 Demonstrate and Validate Sprints',
...
var txtPortfolio = {
	...
	project: {
		...
		sos: [
			'<b>Scrum of Scrums (SoS) Meeting</b>',
...
var txtSummary = {
	...
	table: [
		...
		},
		{
            ...
            comments: [
                'Solves problems and coordinates meetings for pro'
            ]
		},
		{
            owner: 'Stakeholder(s)',
...
exports.txtOwner = txtOwner;
exports.txtMaster = txtMaster;
exports.txtTeam = txtTeam;
exports.txtPortfolio = txtPortfolio;
exports.txtSummary = txtSummary;
exports.txtVersus = txtVersus;
exports.txtTheories = txtTheories;
